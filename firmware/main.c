 ...
 *
 * 2015-11-18 jarodlau@gmail.com
 * 合并编程89s52,自动调速,另外usbserial number显示我自己的邮箱,是不是很酷!!
 */
	...
	if (data[1] == USBASP_FUNC_CONNECT) {
	  ...
	  len = 4;
		...
		//    replyBuffer[0] = ispEnterProgrammingMode();
         	replyBuffer[0] = ispEnterProgrammingMode_jarodlau();//代码修改成自动降速,jarodlau@gmail.com
		len = 1;
